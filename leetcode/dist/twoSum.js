...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"twoSum.js":[function(require,module,exports) {
// /**
//  * @param {number[]} nums
//  * @param {number} target
//  * @return {number[]}
...
var twoSum = function twoSum(nums, target) {
  ...
  for (var i = 0; i < nums.length; i++) {
    for (j = 0; j < nums.length; j++) {
      ...
      j = i + 1;
      console.log(clear); // console.log(nums[j])
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","twoSum.js"], null)
