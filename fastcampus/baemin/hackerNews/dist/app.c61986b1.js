...
function newsFeed() {
  ...
  for (var i = (store.currentPage - 1) * 10; i < store.currentPage * 10; i++) {
    newsList.push("\n            <div class=\"p-6 ".concat(newsFeed[i].read ? 'bg-gray-300' : 'bg-white', " mt-6 rounded-lg shadow-md transition-colors duration-500 hover:bg-green-100\">\n                <ul class=\"flex\">\n                    <li class=\"flex-auto\">\n                        <a href=\"#/show/").concat(newsFeed[i].id, "\">").concat(newsFeed[i].title, "</a>  \n                    </li>\n                    <li class=\"text-center text-sm ml-10\">\n                        <div class=\"w-10 text-white bg-green-600 rounded-lg px-0 py-2\">").concat(newsFeed[i].comments_count, "</div>\n                    </li>\n                </ul>\n                <div class=\"flex mt-3\">\n                    <ul class=\"text-sm text-gray-500 flex\">\n                        <li><i class=\"fas fa-user mr-1\"></i>").concat(newsFeed[i].user, "</li>\n                        <li class=\"mx-5\"><i class=\"fas fa-heart mr-1\"></i>").concat(newsFeed[i].points, "</li>\n                        <li><i class=\"far fa-clock mr-1\"></i>").concat(newsFeed[i].time_ago, "</li>\n                    </ul>  \n                </div>\n            </div>    \n        "));
  }
  ...
  template = template.replace('{{__total_page__}}', newsFeed.length / 10); //하기 코드의 경우, null 값이 들어갈 수 있다고 명시한 에러가 발생한다. HTMLElement | null
...
function newsDetail() {
  ...
  function makeComment(comments, called) {
    ...
    var commentString = []; // i의 타입은 명시한적이 없지만 에러로 뜨지 않는 이유는 타입스크립트가 추론을 해서 숫자형으로 인지해서 임의로 타입을 지정해줌
